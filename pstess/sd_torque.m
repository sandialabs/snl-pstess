...
% Input:  a state matrix of interconnected generator system
...
%
% Output: Ts synchronizing torque as a function of frequency
...
[f,yda] = state_f(ad,bda,cd(:,crow),zeros(n_mac),eye(n_mac),0.01,0.01,5);
[f,ydw] = state_f(ad,bdw,cd(:,crow),zeros(n_mac),eye(n_mac),0.01,0.01,5);
