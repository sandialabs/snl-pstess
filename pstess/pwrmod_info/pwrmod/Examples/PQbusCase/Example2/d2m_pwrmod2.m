% 2-machine PST simulation with lmod control on buses 1 and 3. 
...
% num volt angle p_gen q_gen p_load q_load G_shunt B_shunt type q_max q_min v_rated v_max v_min
  ...
  2   1.0  0.0   0     0     0.005 0.001 0       0       3    0     0     20      1.5   0.5; %Solar gen
  3   1.0  0.0   0     0     0.05  0.01  0       0       3    0     0     20      1.5   0.5; %Solar gen
...
%bus  T    Pmax Pmin  Tq   Qmax  Qmin
  2   0.05 0.01 -0.01 0.05 0.01 -0.01; 
  3   0.05 0.01 -0.01 0.05 0.01 -0.01];
