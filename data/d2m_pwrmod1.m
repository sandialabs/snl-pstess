...
ex1_step = 1/240;
sw_con = [...
    0.0        0    0    0    0    0    ex1_step;   % sets intitial time step
    5.0        6    1    0    0    5    ex1_step;   % loss of load at bus
%   5.0+3/60   0    0    0    0    0    ex1_step;   % clear near end of fault
%   5.0+4/60   0    0    0    0    0    ex1_step;   % clear far end of fault
    5.5        0    0    0    0    0    ex1_step;   % adjust time step
   10.0        0    0    0    0    0    ex1_step];  % end simulation
