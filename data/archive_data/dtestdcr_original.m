...
bus = [...
   1  1.03    18.5   5.0   1.61  0.00  0.00  0.00  0.00 1  99.0  -99.0  22.0   1.1  .9;
   2  1.01    8.80   5.00   5.76  0.00  0.00  0.00  0.00 2  99.0  -99.0  22.0   1.1  .9;
   ...
   11 1.03    -6.8   5.00   1.49  0.00  0.00  0.00  0.00 2  99.0  -99.0  22.0   1.1  .9;
   12 1.01    -16.9  5.00   1.39  0.00  0.00  0.00  0.00 2  99.0  -99.0  22.0   1.1  .9;
   ...
   16 1.0     -10   10.9    5.00  0.00  0.00  0.00  0.00 1  99.0  -99.0  115.0  1.2  .5;
...
line = [...
   ...
   16   5  0.0     0.001    0.00    1.0  0. 5.0 0.5 0.005;
...
dcl_con = [...
      1  2  10  50.0  0  1000.0  1000.0  800  15];
...
mac_con = [ ...
   ...
   4 12 900 0.200  0.00   1.8  0.30  0.25 8.00  0.03...
      ...
      6.5  0  0  12;
   5 16 1900 0.200  0.00   1.8  0.30  0.25 8.00  0.03...
      1.7  0.55  0.25 0.4   0.05...
      6.5  0  0  12 ];
...
pss_con = [...
   ...
   1 5 300.0  20.0  0.06  0.04  0.08  0.04  0.2  -0.05];
...
load_con = [...
    5  0  0  0  0;
   15  0  0  0  0];
% infinite bus generator 5 - bus 16
%ib_con = [0 0 0 0 1]';
