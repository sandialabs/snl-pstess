...
4 12 1000 0.200  0.0025  1.8  0.30  0.25 8.00  0.03...
                       1.7  0.55  0.25 0.4   0.05...
  6.5  13  0  12;
5 22 200 0.200  0.0025 1.8  0.3   0.25  5.00 0.03...
                       1.7  0.55  0.25  0.4  0.05...
  5.0  10.0  0  22];
...
1 5 100.0  20.0  0.06  0.04  0.08  0.04  0.05 -0.02];
...
0.25   0    0    0    0    0    0.0083; % increase time step 
0.631  0    0    0    0    0    0.0083;
0.75   0    0    0    0    0    0.01;
0.808  0    0    0    0    0    0.01;
5.0    0    0    0    0    0    0.0]; % end simulation
%
%
% file to define capacitor or reactor switching
% col1   time (s) must be a time entered in sw_con
% col2   bus number at which capacitor or reactor is to be added
% col3   switching flag 1 add; -1 remove
% col4   susceptance in pu on system base
% you may specify up to 4 switchings
%scr_con = [...
%0.631  21  1   1.0;
%0.808  21  1   0.5;
%];
