...
% note: machine 1 uses mac_sub model
mac_con = [
1 2 600    0.188 0  1.58  0.33  0.25 8.75 0.11 ...
                    1.56  0.52  0.25 0.9  0.085 ...
                    10.2  0     0    2    0    0;
2 1 1e6    0     0  0     0.146 0    0    0 ...
                    0     0     0    0    0 ...
                    2.364 0     0    1    0    0;
];
% Exciter data format
...
%	    9. Vrmin
exc_con = [
0  1 0.01 200.0 .0 0.0 0.0 100.0 -100.0;
];
%pss data format
...
%8. lag time constant
%9. max output limit
%pss_con= [1 1 0. 30 .1 .04 .1 .04 .1 -.05];
ibus_con=[0 1]';
disp('infinite bus')
